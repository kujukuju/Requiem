...
public class DirectionalLight implements Light {
    ...
    public DirectionalLight(Vector4f lightDir) {
        this(lightDir, new Vector4f(1f, 1f, 1f, 1f), new Vector4f(0.05f, 0.05f, 0.05f, 1f), new Vector4f(1f, 1f, 1f, 1f));
    }

    public DirectionalLight(Vector4f lightDir, Vector4f lightDiffuse) {
        this(lightDir, lightDiffuse, new Vector4f(0.05f, 0.05f, 0.05f, 1f), lightDiffuse);
    }

    public DirectionalLight(Vector4f lightDir, Vector4f lightDiffuse, Vector4f lightAmbient, Vector4f lightSpecular) {
        lightType = 0;
